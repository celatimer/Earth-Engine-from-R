...
# plot interactive map of HM
map <- ee_map(eeobject = hm,
       bands = c('gHM'),
...
# Save map as static .png file in your working directory
mapshot(map, file = paste0(getwd(), "/map.png"), remove_controls = NULL)
```
...
CO_map <- ee_map(eeobject = coloradoHM,
       bands = c('gHM'),
       vizparams = list(palette = list('blue','green','yellow','orange','red','magenta'), 
                        min = 0,
                        max = 1),
...
mapshot(CO_map, file = paste0(getwd(), "/co_map.png"), remove_controls = NULL)
```
